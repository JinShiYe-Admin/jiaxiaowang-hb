...
mui.init({
	...
	pullRefresh: {
		container: ".mui-slider-group", //通过id找到下拉刷新容器标识，querySelector能定位的css选择器均可，比如：id、.class等
		up: {
...
function pulldownRefresh() {
	...
	mui('.mui-slider-group').pullRefresh().endPulldownToRefresh();
}
//四个列表的上拉次数
var more1 = 0,
	more2 = 0,
